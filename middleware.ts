...
export const config = {
  ...
  matcher: ['/((?!api|_next/static|_next/image|assets|favicon.ico|sw.js|manifest.json|site.webmanifest).*)']
}
...
export function middleware(req: NextRequest) {
  ...
  if (
    ...
    console.log('redirecting to', `/${lng}${req.nextUrl.pathname}${req.nextUrl.search}`)
